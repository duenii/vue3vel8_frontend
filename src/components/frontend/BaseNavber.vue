 ...
 <header class="fixed w-full py-4 bg-white shadow-md">
        ...
        <nav class="container flex flex-wrap items-center px-4 mx-auto">
            ...
            <div class="hidden w-full ml-auto lg:block lg:w-auto">
                <router-link to="/" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> Home</router-link>
                <router-link to="/about" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> About</router-link>
                <router-link to="/service" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> Service </router-link>
                <router-link to="/contact" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> Contact</router-link>
                <router-link to="/register" class="block px-4 py-2 font-medium hover:text-indigo-900 lg:inline-block"> Blog</router-link>
                <div class="inline-block px-4 py-2">
                    <router-link to="/login" class="inline-block px-6 py-2 text-white bg-indigo-600 border-2 border-indigo-600 rounded-md hover:text-indigo-600 hover:bg-indigo-100">Contact Now</router-link>
                </div>
            </div>
        </nav>
